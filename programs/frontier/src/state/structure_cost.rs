...
// const CARPENTER_HUT_BASE_COST: Resources = Resources { wood: 750, stone: 200, iron: 0, steel: 0, mana: 0, gold: 0 };
// const BLACKSMITH_BASE_COST: Resources = Resources { wood: 750, stone: 250, iron: 0, steel: 0, mana: 0, gold: 0 };
// const MANA_WELL_BASE_COST: Resources = Resources { wood: 150, stone: 750, iron: 0, steel: 0, mana: 0, gold: 0 };
...
pub fn get_cost(structure_type: StructureType) -> Option<Resources> {
    match structure_type {
        ...
        // StructureType::ArcherTower => Some(castle[0]),
        // StructureType::MageTower => Some(castle[0]),
        // StructureType::Wall => Some(castle[0]),
        // StructureType::SentryCreature => Some(castle[0]),
        _ => None,
    }
}
